 ...
 *
 * 此AIDL文件来自：
 * https://github.com/android/platform_frameworks_base/blob/android-5.1.1_r29/telephony/java/com/android/internal/telephony/ITelephony.aidl
 *
 * 为了成功编译，以及尽量不添加不必要的文件，而且不需要此功能，故删除了2处 RadioAccessFamily 相关的内容：
 * 1. import android.telephony.RadioAccessFamily;
 * 2. void setRadioCapability(in RadioAccessFamily[] rafs);
 */
